...
cprintf([0.5,0,0],'WELCOME TO OPEN-REALTIME-FMRI\n');
...
if (~exist('synchronizetopulse','var'))
...
if (moveoldseriesfiles && ~cburt.lowlatency.disablesiemensrealtime)
    ...
    fprintf('Moved old series files to %s (as 4th argument to cburt_watcher is set)',oldseriespth);
end;
