...
%% QA report folder
qadir = '/realtime/scratch/processed/qareport/';
...
Chan = dcmparser(cburt.incoming.series(seriesnum).receivedvolumes{1},'asCoilSelectMeas[0].asList[11].lRxChannelConnected = ');
Chan = str2double(Chan); fprintf('CHAN  = %.6f\n\n', Chan);
...
textread([qadir 'QA.txt'], '%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f');
...
print(figure(23),'-dpng','-r130', fullfile(qadir,'QA-history.png')  )
