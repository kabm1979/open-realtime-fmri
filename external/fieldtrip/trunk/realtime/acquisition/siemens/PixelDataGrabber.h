...
class PixelDataGrabber {
	...
	*/
	enum ProtocolFormat { MrProtUseLast, ShadowDataUseOnce, ShadowDataUseLast, ShadowDataAuto};
	...
	*/
	...
	int getNumWrittenSinceLastReport();
	/** Returns a code for errors or the action carried out during the last run() */
	Action getLastAction() const { return lastAction; }
	ProtocolFormat getProtocolFormat() const { return protocolFormat; };
	void setProtocolFormat(ProtocolFormat newProtocolFormat) { protocolFormat=newProtocolFormat; };
	...
	*/
	bool handleProtocol(const char *info, unsigned int sizeInBytes);
	...
	*/
	...
	unsigned int lastSampleReported;	/**< Number of samples written to the currently connected buffer */
	...
	std::string currentSeriesDirectory;
	...
	bool gotprotocol;
	bool gotprotocolthisseries;
	bool writtenheaderthisseries;
	ProtocolFormat protocolFormat;
	ProtocolFormat protocolFormatThisSeries;
	
	std::list<std::string> protocolq;	/**< Contains the full path of the last pixeldata files transmitted */
	std::list<std::string> pixeldataq;	/**< Contains the full path of the last pixeldata files transmitted */
